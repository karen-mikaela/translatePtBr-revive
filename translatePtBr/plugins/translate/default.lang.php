...
$GLOBALS['strCampaignType'] = "Tipo da campanha";
$GLOBALS['strContract'] = "Contato";
$GLOBALS['strStandardContract'] = "Contrato";
...
$GLOBALS['strOverride']                         = "Sobreposição";
$GLOBALS['strOverrideInfo']                     = "Campanhas de sobreposição são um tipo de campanha especial especificamente para
     sobrepor (ex. ter prioridade sobre) campanhas remanescente e de contrato. Campanhas de sobreposição são geralmente usados com
     o direcionamento específico e / ou tampando regras para garantir que os banners da campanha são sempre exibidos em determinados
     locais, para determinados usuários e, talvez, um certo número de vezes, como parte de uma promoção específica. (Este tipo de campanha
     era anteriormente conhecida como 'Contrato (Exclusivo)'.)";
$GLOBALS['strStandardContractInfo']             = "Campanhas de contrato são para entregar sem problemas as impressões
     necessária para atingir um requisito de desempenho de tempo crítico especifico. Ou seja, campanhas de Contrato são para quando
     um anunciante pagou especificamente para ter um determinado número de impressões, cliques e / ou conversões de ser
     conseguida entre duas datas, ou por dia.";
$GLOBALS['strRemnant']                          = "Remanescente";
$GLOBALS['strRemnantInfo']                      = "É o tipo de campanha padrão. Campanhas remanescentes têm lotes de diferente opções
     de entrega, o ideal é você ter sempre pelo menos uma campanha Remanescente programada para cada zona, para garantir que há sempre 
     algo para mostrar. Use campanhas Remanescentes para exibir banners da casa, banners ad-network, ou mesmo
     publicidade direta que foi vendida, mas onde não tenha um requisito de performance de tempo crítico para a  campanha aderir.";
$GLOBALS['strECPMInfo']                         = "Esta é uma campanha padrão que pode ser restringida com uma data final ou um limite específico. Com base nas configurações atuais que serão priorizados usando eCPM.";
$GLOBALS['strContractCampaign']                 = "Campanha de contrato";
$GLOBALS['strRemnantCampaign']                  = "Campanha remanescente";
$GLOBALS['strPricing']                          = "Como minha campanha será cobrada";
$GLOBALS['strPricingModel']                     = "Forma de venda";
$GLOBALS['strSelectPricingModel']               = "-- Selecione --";
$GLOBALS['strRatePrice']                        = "Taxa / Preço";
